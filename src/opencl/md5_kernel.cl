...
__kernel void md5(__global uint *data_info, __global const uint * keys, __global uint * hashes, __global const uint* loaded_hash, __global const uint* loaded_count, __global uint *match_count, __global uint* cracked_count)
{
    ...
    if (id < init_count) {
        ...
        uint h1 = hashes[id] = a + 0x67452301;
